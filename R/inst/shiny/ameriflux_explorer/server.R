...
# source('/data/Dropbox/Research_Projects/code_repository/bitbucket/amerifluxr/R/aggregate.flux.data.r')
# source('/data/Dropbox/Research_Projects/code_repository/bitbucket/amerifluxr/R/smooth.ts.r')
# source('/data/Dropbox/Research_Projects/code_repository/bitbucket/amerifluxr/R/optimal.span.r')
...
server <- function(input, output, session){
  ...
  downloadData <- function(myrow){
    ...
    if(inherits(status,"try-error")){
      ...
      plot_data = aggregate.flux.data(data)
      return(plot_data)
    }
  }
